Contributing to Midas Core
============================

The Midas Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Midas Core project, and is not to be
confused with overall Midas Network Protocol consensus changes.

Whether a pull request is merged into Midas Core rests with the project merge
...
Patches that change Midas consensus rules are considerably more involved than
...
Where a patch set proposes to change the Midas consensus, it must have been
...
The project leader is the release manager for each Midas Core release.
