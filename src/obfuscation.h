...
static const CAmount OBFUSCATION_POOL_MAX = (9999.99 * COIN);
...
{
public:
    /// Is the inputs associated with this public key? (and there is 1000 Midas - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of midas.
