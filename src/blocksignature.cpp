...
bool CheckBlockSignature(const CBlock& block)
{
    ...
    /** Each block is signed by the private key of the input that is staked. This can be either MDS or normal UTXO
     *  MDS: Each MDS has a keypair associated with it. The serial number is a hash of the public key.
