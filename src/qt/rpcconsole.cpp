                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strMDSPathCustom = GetArg("-mdsbackuppath", "");
    ...
    if(!strMDSPathCustom.empty()) {
        ui->wallet_custommdsbackuppath->setText(QString::fromStdString(strMDSPathCustom));
        ui->wallet_custommdsbackuppath_label->setVisible(true);
        ui->wallet_custommdsbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strMDSPathCustom.empty()) && nCustomBackupThreshold > 0) {
