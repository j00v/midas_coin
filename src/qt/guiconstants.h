...
/* Midas GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Midas"
#define QAPP_ORG_DOMAIN "midas.org"
#define QAPP_APP_NAME_DEFAULT "Midas-Qt"
#define QAPP_APP_NAME_TESTNET "Midas-Qt-testnet"
