                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Midas Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for Midas"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Midas Core"), this);
    aboutAction->setStatusTip(tr("Show information about Midas Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Midas Core help message to get a list with possible Midas command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Midas Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Midas Core"); // default title
