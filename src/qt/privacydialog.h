...
public:
    ...
    void setZMdsControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintMDS_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendMDS_clicked();
    void on_pushButtonZMdsControl_clicked();
