...
/** Utility functions used by the Midas Qt UI.
 */
namespace GUIUtil
{
...
// Render Midas addresses in monospace font
...
// Parse "midas:" URI into recipient object, return true on successful parsing
