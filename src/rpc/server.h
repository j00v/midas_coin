...
extern UniValue setmdsseed(const UniValue& params, bool fHelp);
extern UniValue getmdsseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdmds(const UniValue& params, bool fHelp);
extern UniValue dmdsstate(const UniValue& params, bool fHelp);
