...
In order to support loading of multiple wallets in midas-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is midas.cpp.
...
Changes to midas.cpp
----------------------
midas.cpp is the entry point into midas-qt, and as such, will require some minor modifications to provide hooks for
